...
public class DistanceVectorRouting extends Topology {

    HashMap<String, String[]> routingTable;
    HashMap<String, HashMap<String, Integer>> distanceVectorTable;

    public DistanceVectorRouting(String username, String password) {
        super(username, password);
        this.routingTable = new HashMap<>();
        this.routingTable.put(username, getNeighbors(username));

        this.distanceVectorTable = new HashMap<>();
    }
     ...
     * @return
     */
    private String[] shortespathPesos(String to) {
        try {
    ...
    public void sendInitialLSA() {
        ...
        System.out.println("Send initial LSA to: " + Arrays.toString(neighbors));
    ...
    protected void sendMessage(String to, String message) {
        ...
        String[] path = this.shortespathPesos(to);

        if (path == null) {
            System.out.println("No se pudo encontrar un camino para entregar el mensaje");
            return;
        } else {
            System.out.println("Camino encontrado: " + Arrays.toString(path));
            JSONObject json = new JSONObject();
            json.put("type", "MESSAGE");
            json.put("message", message);
            json.put("from", username);
            json.put("saltos", path.length - 1);
            ...
            System.out.println("Mensaje reenviado a: " + path[1]);
        }
    }
    ...
    public static void start() {
        ...
        System.out.print("Ingrese su nombre de usuario (DistanceVectorRouting): ");
        String username = scanner.nextLine();
        System.out.print("Ingrese su contraseña: ");
        String password = scanner.nextLine();

        DistanceVectorRouting routing = new DistanceVectorRouting(username, password);
        routing.connect();
